...
message = {
    ...
    "Product_Menu": "На данный момент мы выполняем:\n\tКурсовые работы\n\tДипломные работы\n\tИ многое другое...",
...
adminMessage = {
    ...
    "code_del_no": "Удаление промокода отменено",
